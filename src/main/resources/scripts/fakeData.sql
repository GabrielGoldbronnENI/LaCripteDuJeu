...
-- Table copy
INSERT INTO copy (status, product_id)
VALUES
    (TRUE, 1),
    (FALSE, 2),
    (TRUE, 3),
...
-- Table location
INSERT INTO location (price, status, product_id, user_id)
VALUES
    (5.99, 2, 1, 1),
    (7.99, 1, 2, 2),
    (6.99, 2, 3, 1),
...
-- Table rental_status_location
INSERT INTO rental_status_location (rental_status_id, location_id)
VALUES
    (2, 1),
    (1, 2),
    (2, 3),
